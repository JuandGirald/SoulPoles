...
(function() {
  Spree.ready(function($) {
    ...
    $('.grip-colors.right-grip li, .basket.right-basket li').click(function(event) {
      var right;
      event.preventDefault();
      ...
      return $("input[name='product[basket_right]']").val(right);
    });
    $('.grip-colors.left-grip li, .basket.left-basket li, .grip-colors.right-grip li, .basket.right-basket li, .basket.basket-size li').click(function(event) {
      var value;
      event.preventDefault();
      $(this).siblings("li.select").removeClass("select");
      $(this).addClass('select');
      ...
      return $(this).siblings("input[name='product[basket_size]']").val(value);
    });
    return $('.size-values li').click(function(event) {
      var size;
      event.preventDefault();
      $("li.select").removeClass("select");
      $(this).addClass('select');
      size = $(this).attr('value');
      return $("input[name='product[pole_size]']").val(size);
    });
  });
